...
Ví dụ: `https://xizot.github.io/shared-ui/`
...
**Mặc định base path là `/shared-ui/`** (đã được cấu hình sẵn).
...
- Kiểm tra base path trong `vite.config.preview.ts` (mặc định: `/shared-ui/`)
...
- **Giải pháp**:
  ...
  2. Kiểm tra trong `dist-preview/index.html` - paths phải bắt đầu với `/shared-ui/`
