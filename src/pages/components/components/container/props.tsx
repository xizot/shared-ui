    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Complete reference for Container component props and types.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Container component extends standard div HTML attributes</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              <TableRow>
                <TableCell className="font-mono font-medium">maxWidth</TableCell>
                <TableCell className="font-mono text-sm">'sm' | 'md' | 'lg' | 'xl' | '2xl' | 'full'</TableCell>
                <TableCell className="font-mono text-sm">'xl'</TableCell>
                <TableCell>Maximum width of the container</TableCell>
              </TableRow>
              <TableRow>
